...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="specific task from the all_features pipeline."
        "if not set, run the all_features steps.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '--feature', choices=['select', 'all_features'], default='all_features', help='pre-define feature select or all_features table use'
    )
    parser.add_argument(
